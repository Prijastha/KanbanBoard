...
const KanbanBoard = () => {
  ...
  function onDragStart(event: DragStartEvent) {
    if (event.active.data.current?.type === "column") {
      const draggedColumn = event.active.data.current.column;
      ...
      >
        <div className="m-auto flex gap-4">
          ...
          <button
            ...
            className="h-[60px] w-[350px] cursor-pointer min-w-[350px] rounded-lg bg-mainBackgroundColor border-columnBackgroundColor p-4 ring-purple-300 hover:ring-2 flex gap-8"
          >
            <PlusIcon /> Add Column
          </button>
        </div>
